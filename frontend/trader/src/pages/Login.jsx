  ...
  return (
    <AuthShell>
      <AuthCard onSubmit={handleSubmit}>
        <AuthHeader icon={<IconUser />} title="Trader Login" subtitle="Access your trading dashboard" />
        <AuthProgress step={1} />
         ...
         * pretending a reset mail was sent.
         */}
        ...
        {forgotNote && (
          <p className="mp-authForgotNote">Password reset isn’t available yet — contact your MaxPay administrator.</p>
        )}
